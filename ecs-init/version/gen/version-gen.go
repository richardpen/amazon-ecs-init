...
// ecs-init. It is autogenerated package version

// Please DO NOT commit any changes to this file (specifically the hash) except
// for those created by running ./scripts/update-version.sh at the root of the
...
// version-gen is a simple program that generates the ecs-init's version file,
// containing information about the ecs-init's version, commit hash, and repository
// cleanliness.
func main() {
